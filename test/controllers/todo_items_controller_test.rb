...
class TodoItemsControllerTest < ActionController::TestCase
  ...
  test "should create todo_item" do
    assert_difference('TodoItem.count') do
      post :create, todo_item: { assignee: @todo_item.assignee, status: @todo_item.status, task: @todo_item.task }
    end
  ...
  test "should update todo_item" do
    patch :update, id: @todo_item, todo_item: { assignee: @todo_item.assignee, status: @todo_item.status, task: @todo_item.task }
    assert_redirected_to todo_item_path(assigns(:todo_item))
  end
